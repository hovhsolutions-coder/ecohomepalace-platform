        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 rounded-[2rem] border border-white/10 bg-white/5 p-10 md:p-12">
            ...
            <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl md:text-6xl">
              Get Free {service.title} Quotes from Local Specialists
            </h1>
            ...
            <div className="mt-8 rounded-xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-2 text-sm text-white/60">
                You&apos;ll be connected with verified local professionals who typically respond within 24 hours.
                Free quotes, no obligation, compare multiple offers.
              </p>
            </div>
