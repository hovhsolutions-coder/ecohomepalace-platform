...
export const countries: Record<string, { name: string; description: string; cities: MarketCity[] }> = Object.fromEntries(
  countryMarkets.map((country) => [country.slug, country])
);
